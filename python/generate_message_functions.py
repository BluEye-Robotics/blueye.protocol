...
TEMPLATE_ENVIRONMENT = Environment(autoescape=False, loader=FileSystemLoader(os.path.join(MODULE_PATH, 'templates')))
...
def write_function():
    ...
    with open(file_name, 'w') as f:
        for command in tcp_protocol['commands']:
            ...
            python_command = TEMPLATE_ENVIRONMENT.get_template('send_command_function_template.py').render(command)
